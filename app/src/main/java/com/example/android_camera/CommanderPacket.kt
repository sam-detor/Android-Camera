...
class CommanderPacket(roll: Float, pitch: Float, yaw: Float, thrust: UShort): CrtpPacket(0,
    CrtpPort.COMMANDER
) {
...
class CommanderHoverPacket(vx: Float, vy: Float, vyaw: Float, dis: Float): CrtpPacket(0,
